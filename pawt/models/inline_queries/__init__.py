...
# todo this sub-package could probably use better integration with the rest of
# todo the package. Perhaps something like automatic conversions from main
# todo types to result types… As it stands, they're glorified dicts.
