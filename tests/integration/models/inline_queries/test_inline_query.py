...
def test_respond():
    input_content = InputTextMessageContent('[Stephen Hawking: Visionary '
                                            ...
                                            'uk-43396008)',
                                            parse_mode='Markdown')
    article = InlineQueryResultArticle('a', 'Stephen Hawking: Visionary '
                                            'physicist dies aged 76',
                                       input_content, url='http://www.bbc.com/'
                                                          'news/uk-43396008')
    with bm.use_cassette('test_inline_query__test_respond'):
        ...
        iq.answer([article], cache_time=400, is_personal=True, next_offset='2',
                  switch_pm_text='Read more', switch_pm_parameter='Hawking')
