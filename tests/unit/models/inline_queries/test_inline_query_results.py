...
def test_article():
    data = {"title": "Hello world!", "input_message_content": INPUT_MESSAGE_CONTENT}
    expected = data.copy()
    expected["id"] = "abc123"
...
def test_audio():
    data = {
        "audio_url": "https://my.site/song.mp3",
        "title": "Hello world!",
        "audio_duration": 300,
...
def test_cached_sticker():
    data = {"sticker_file_id": "def456", "input_message_content": INPUT_MESSAGE_CONTENT}
    expected = data.copy()
    expected["id"] = "abc123"
...
def test_document():
    data = {
        "title": "Cool Document",
        "document_url": "http://site.com/doc.pdf",
...
def test_mpeg4_gif():
    data = {
        "mpeg4_url": "http://site.com/img.gif",
        "thumb_url": "http://site.com/img.png",
        "input_message_content": INPUT_MESSAGE_CONTENT,
    }
    expected = data.copy()
...
def test_photo():
    data = {
        "photo_url": "http://site.com/img.jpg",
        "thumb_url": "http://site.com/img.png",
        "input_message_content": INPUT_MESSAGE_CONTENT,
    }
    expected = data.copy()
...
def test_video():
    data = {
        "video_url": "https://my.site/vid.mp4",
        "mime_type": "video/mp4",
        "thumb_url": "https://my.site/thumb.png",
...
def test_voice():
    data = {
        "voice_url": "https://my.site/voice.ogg",
        "title": "The best voice",
        "input_message_content": INPUT_MESSAGE_CONTENT,
    }
    expected = data.copy()
    expected["id"] = "abc123"
